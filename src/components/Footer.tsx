        ...
        <div style={{
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 20, alignItems: "flex-end" }}>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              <a href="https://wa.me/5511952364424" target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", alignItems: "center", gap: 7, padding: "6px 12px", borderRadius: 6, border: "1px solid var(--border)", color: "var(--muted-2)", fontSize: 12, fontFamily: "var(--font-mono)", textDecoration: "none", transition: "border-color 0.2s, color 0.2s" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(37,211,102,0.3)"; (e.currentTarget as HTMLElement).style.color = "var(--text)" }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = "var(--border)"; (e.currentTarget as HTMLElement).style.color = "var(--muted-2)" }}>
              ...
              <a href="https://instagram.com/tech.tsu" target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", alignItems: "center", gap: 7, padding: "6px 12px", borderRadius: 6, border: "1px solid var(--border)", color: "var(--muted-2)", fontSize: 12, fontFamily: "var(--font-mono)", textDecoration: "none", transition: "border-color 0.2s, color 0.2s" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(193,53,132,0.3)"; (e.currentTarget as HTMLElement).style.color = "var(--text)" }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = "var(--border)"; (e.currentTarget as HTMLElement).style.color = "var(--muted-2)" }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none">
