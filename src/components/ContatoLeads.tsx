            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <a href="https://wa.me/5511952364424" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp"
                ...
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2 22l4.95-1.418A9.96 9.96 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18a7.96 7.96 0 01-4.07-1.115l-.292-.174-3.027.869.852-3.11-.19-.312A7.96 7.96 0 014 12c0-4.418 3.582-8 8-8s8 3.582 8 8-3.582 8-8 8z" fill="rgba(255,255,255,0.5)"/>
                </svg>
              </a>
              ...
              <a href="https://instagram.com/tech.tsu" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                ...
                <svg width="17" height="17" viewBox="0 0 24 24" fill="none">
                  ...
                  <circle cx="12" cy="12" r="4.5" stroke="rgba(255,255,255,0.5)" strokeWidth="1.5"/>
