          ...
          >
            ...
            <div style={{ display: "flex", gap: 10, justifyContent: "center", flexWrap: "wrap" }}>
              ...
              <a href="https://wa.me/5511952364424" target="_blank" rel="noopener noreferrer"
                ...
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(37,211,102,0.35)"; (e.currentTarget as HTMLElement).style.color = "var(--text)" }}
              ...
              <a href="https://instagram.com/tech.tsu" target="_blank" rel="noopener noreferrer"
                style={{ display: "flex", alignItems: "center", gap: 8, padding: "10px 16px", borderRadius: 6, border: "1px solid var(--border)", color: "var(--muted)", fontSize: 13, fontFamily: "var(--font-mono)", textDecoration: "none", transition: "border-color 0.2s, color 0.2s" }}
                onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = "rgba(193,53,132,0.35)"; (e.currentTarget as HTMLElement).style.color = "var(--text)" }}
                onMouseLeave={e => { (e.currentTarget as HTMLElement).style.borderColor = "var(--border)"; (e.currentTarget as HTMLElement).style.color = "var(--muted)" }}>
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none">
